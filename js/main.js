const tabData = {
    main: [
        ...
        { title: 'Стафф', description: 'Полное управление персоналом и отслеживание их статистики', price: '800 ₽' }
    ],
    protection: [
    ...
    tools: [
        ...
        { title: 'Наборы', description: 'Система наборов в стафф, автоматизация черного списка', price: '300 ₽' },
